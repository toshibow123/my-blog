  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-80px)]">
        {/* 左側: ヒーロー画像エリア（2/3幅） */}
        <div className="lg:w-2/3 relative bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800">
            ...
            <div className="max-w-2xl">
              <AnimatedCard>
                <div className="space-y-6">
                  ...
                  <h1 className="text-5xl lg:text-7xl font-bold mb-4 bg-gradient-to-r from-yellow-300 via-yellow-200 to-yellow-300 bg-clip-text text-transparent leading-tight">
                    {featuredPost.title}
                  </h1>
          ...
          <div className="p-6 lg:p-8 space-y-8">
            ...
            <section>
              <div className="relative mb-6">
                <h2 className="text-6xl font-bold text-white opacity-20 absolute -top-2 -left-2 select-none">
                  NEWS
                </h2>
                  ...
                  <AnimatedCard key={post.id} delay={index * 0.1}>
                    <HoverCard>
                      <Link
                        ...
                        className="block p-4 bg-gray-700/50 hover:bg-gray-700 rounded-lg transition-colors border border-gray-600 hover:border-yellow-500/50 group"
                        prefetch={true}
                      >
                        <div className="flex items-start gap-3">
                          <div className="flex-1">
                            ...
                            <h3 className="text-white font-semibold mb-1 line-clamp-2 group-hover:text-yellow-400 transition-colors">
                              {post.title}
                            </h3>
              ...
              <div className="bg-gray-700/50 rounded-lg p-4 border border-gray-600">
                ...
                <div className="space-y-2 text-sm">
                  {allPosts.slice(0, 3).map((post) => (
                    <div key={post.id} className="flex items-center gap-2 text-gray-400">
            ...
            <section>
              <div className="relative mb-6">
                ...
                <h2 className="text-4xl font-bold text-white relative z-10">CATEGORY</h2>
              </div>
              <div className="flex flex-wrap gap-2">
                {["プログラミング", "節約", "筋トレ", "AI", "資産形成"].map((cat) => (
                  <Link
                    key={cat}
                    href={`/category/${cat.toLowerCase()}`}
                    className="bg-gray-700/50 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors border border-gray-600 hover:border-yellow-500/50 text-sm"
                    prefetch={true}
                  >
                    {cat}
                  </Link>
